    ...
    <nav id="myNavbar" class="navbar navbar-inverse" role="navigation">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">YES Mart</a>
            </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="thumbnail">
                         <a class="thumbnail pull-left" href="#"> <img src="/medical/myImage/imageDisplay?id=${cart.productId}" style="width:50px;height: 50px" > </a> 
